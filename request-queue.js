...
allow very large "queues" of similar objects. It is partially derived from
...
function Queue(){
   ...
   * 'undefined' is returned.
   */
  this.dequeuearray = function(listlength){

    // if the queue is empty, return immediately
    if (queue.length == 0) return [];

    // if we are somehow asking for less than one element, return immediately
